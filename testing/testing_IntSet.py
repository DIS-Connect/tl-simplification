...
if __name__ == "__main__":
    ...
    pi = PredicateInterval()

    exp = Expression._and(Expression.pred("V1",[]), Expression.pred("V2",[]))

    print(exp)

    I_true, I_false, simp_exp = LTLf.simplify_interval_rec(exp, pi)
